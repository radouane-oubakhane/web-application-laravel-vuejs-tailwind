            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container mx-auto px-6 py-8">
                        ...
                        <div v-if="evenements.length" class="grid grid-rows-2">
                            <div v-for="evenement in evenements" v-if="!annuler"
                                 class="flex flex-col mt-8">
                                <div class="mx-6 flex flex-col justify-center bg-white rounded-md shadow-md shadow-slate-300/60">
                                    <img class="aspect-video w-full rounded-t-md object-cover object-center"
                                         :src="evenement.photo"
                                         alt=""/>
                                    <div class="p-4">
                                        <small class="text-lab-blue text-xs">{{evenement.dateEvenement}}</small>
                                        <h1 class="text-2xl font-medium text-black pb-2">{{evenement.intitule}}</h1>
                                        <p class="text-sm tracking-tight font-light text-lab-blue leading-6">{{evenement.detail}}</p>
                                    </div>
                                </div>
                            </div>
                            <div v-for="evenement in tab" v-if="annuler"
                                 class="flex flex-col mt-8">
                                <div class="mx-6 flex flex-col justify-center bg-white rounded-md shadow-md shadow-slate-300/60">
                                    <img class="aspect-video w-full rounded-t-md object-cover object-center"
                                         :src="evenement.photo"
