...
import DoctorantSideBar from '@/Pages/Doctorant/DoctorantSideBar';
...
let addConf = ref(false);
const delConf = ref(false);
const delId = ref(null);
const updateConf = ref(false);
...
const search = ref('');
const tab = ref(props.conferences);
const message = ref(true);
const errors = ref(true);

watch(search, () => {
    tab.value = props.conferences.filter(
        conference => conference['intitule'].toUpperCase().includes(search.value.toUpperCase())
    )
})
...
function updateConference(id) {
    updateConf.value = !updateConf.value
    conference.id = id
}
function update() {
    Inertia.post('/conferences/doctorant/edit', conference)

}
function delConference(conference) {
    delId.value = conference
    delConf.value = !delConf.value
}
const submit = () => {
    addConf.value = !addConf.value
    Inertia.post('/conferences/doctorant/store', form)
}
</script>
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container mx-auto px-6 py-8">
                        <h3 class="text-gray-700 text-3xl font-medium">Conferences</h3>
                        <div class="px-6 py-8">
                            <button @click="addConf = !addConf" type="button" class="text-white bg-gradient-to-br from-green-600 to-green-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Ajouter une conférence </button>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input @focus="annuler = !annuler"
                                       ...
                                       placeholder="Rechercher des chercheurs, des doctorants, des projets..."
                                       required>
                        ...
                        <div v-if="conferences.length !== 0" class="flex flex-col mt-8">
                            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                <div
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tr v-for="conference in conferences" v-if="!annuler">
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{conference.intitule}}</div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{conference.detail}}</div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{conference.date}}</div>
                                            </td>
                                            <td
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <button
                                                    ...
                                                    @click="updateConference(conference.id)">
                                                    Editer
                                                </button>
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <button
                                                    ...
                                                    @click="delConference(conference.id)">
                                                    Supprimer
                                                </button>
                                            </td>
                                        </tr>
                                        <tr v-for="conference in tab" v-if="annuler">
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{conference.intitule}}</div>
                                            </td>
    ...
    <div v-if="addConf"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter un nouvelle conférence</h3>
                        <form @submit.prevent="submit"
                            ...
                            <div class="mb-4 md:flex md:justify-between">
                                ...
                                <div class="md:ml-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700" for="ville">
                                        Ville
                                    </label>
                                    <input
                                        v-model="form.ville"
    ...
    <div v-if="delConf"
        ...
        <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
            <div class="">
                <div class="text-center p-5 flex-auto justify-center">
                    <h2 class="text-xl font-bold py-4 ">Êtes-vous sûr?</h2>
                    <p class="text-sm text-gray-500 px-8">Voulez-vous vraiment supprimer cette conférence?</p>
                </div>
                <div class="p-3  mt-2 text-center space-x-4 md:block">
                    <button @click="delConf = !delConf" class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-md hover:shadow-lg hover:bg-gray-100">
                        Non
                    </button>
                    <Link
                        ...
                        @click="delConf = !delConf"
                        :href="`/conferences/doctorant/${delId}`"
                        method="delete"
                        as="button"
                        type="button">
                        Oui
    ...
    <div v-if="updateConf"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Editer un conférence</h3>
                        <form
                              class="px-8 pt-6 pb-2 mb-4 bg-white rounded">
                            <div class="mb-2">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="intitule">
