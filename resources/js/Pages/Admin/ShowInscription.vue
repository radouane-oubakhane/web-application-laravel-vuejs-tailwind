...
let addAdmin = ref(false);
let addChercheur = ref(false);
let addDoctorant = ref(false);
let del = ref(false);
let addCher = ref(false);
...
const search = ref('');
const tab = ref(props.inscriptions);
const message = ref(true);
const errors = ref(true);

watch(search, () => {
    tab.value = props.inscriptions.filter(
        inscription => inscription['nom'].toUpperCase().includes(search.value.toUpperCase())
    )
})
...
const adminSubmit = () => {
    ...
    Inertia.post('/comptes/store/admin', admin)
}
const chercheurSubmit = () => {
    Inertia.post('/comptes/store/chercheur', chercheur)
}
const doctorantSubmit = () => {
    Inertia.post('/comptes/store/doctorant', doctorant)
}
...
function refuser(inscription) {
    del.value = !del.value
    delId.value = inscription;
}
function accepter(inscription, fonction) {
    if (fonction === 1)
        addDoc.value = !addDoc.value;
    else
        addCher.value = !addCher.value;
    form.id = inscription;
}
function send() {
    addDoc.value = false;
    addCher.value = false;
    Inertia.post('/comptes/store', form)
}
</script>
...
<template>
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container mx-auto px-6 py-8">
                        <h3 class="text-gray-700 text-3xl font-medium">Demande d'inscription</h3>
                        <div class="mt-8">
                            <div class="mt-4">
                                <div class="flex flex-wrap -mx-6">
                                    <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-8">
                                        <button class="w-full flex justify-center items-center px-5 py-6 shadow-sm rounded-md bg-white"
                                            @click="addAdmin = !addAdmin"
                                        >
                                            <div class="p-3">
                                                <i class="fa-solid fa-user-plus text-lab-red"></i>
                                            </div>

                                            <div class="mx-5">
                                                <div class="text-gray-500 text-lab-red">Ajouter un Admin</div>
                                            </div>
                                        </button>
                                    </div>
                                    ...
                                    <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-8">
                                        <button class="w-full flex justify-center items-center px-5 py-6 shadow-sm rounded-md bg-white"
                                            @click="addChercheur = !addChercheur">
                                            <div class="p-3">
                                                <i class="fa-solid fa-user-plus text-lab-purple"></i>
                                            </div>

                                            <div class="mx-5">
                                                <div class="text-gray-500 text-lab-purple">Ajouter un Chercheur</div>
                                            </div>
                                        </button>
                                    </div>
                                    ...
                                    <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-8">
                                        <button class="w-full flex justify-center items-center px-5 py-6 shadow-sm rounded-md bg-white"
                                              @click="addDoctorant = !addDoctorant">
                                            <div class="p-3">
                                                <i class="fa-solid fa-user-plus text-green-500"></i>
                                            </div>

                                            <div class="mx-5">
                                                <div class="text-gray-500 text-green-500">Ajouter un Doctorant</div>
                                            </div>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div v-if="inscriptions.length !== 0" class="flex flex-col mt-8">
                            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                <div
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tr v-if="!annuler"
                                            v-for="inscription in inscriptions" :key="inscription.id">
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-4">
                                                        <div class="text-sm leading-5 font-medium text-gray-900">{{inscription.nom}} {{inscription.prenom}}
                                                        </div>
                                                        <div class="text-sm leading-5 text-gray-500">CIN : {{inscription.cin}}</div>
                                                    </div>
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{inscription.email}}</div>
                                                <div class="text-sm leading-5 text-gray-500">Tel : {{inscription.numero_telephone}}</div>
                                            </td>
                                            <td
                                                class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500">
                                                {{inscription.fonction}}</td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <button
                                                    @click="accepter(inscription.id, inscription.fonction_id)"
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <button
                                                    ...
                                                    @click="refuser(inscription.id)">
                                                    Refuser
                                                </button>
                                            </td>
                                        </tr>
                                        <tr v-if="annuler"
                                            v-for="inscription in tab" :key="inscription.id">
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <img class="h-10 w-10 rounded-full"
    ...
    <div v-if="del"
        ...
        <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
            <div class="">
                <div class="text-center p-5 flex-auto justify-center">
                    <h2 class="text-xl font-bold py-4 ">Êtes-vous sûr?</h2>
                    <p class="text-sm text-gray-500 px-8">Voulez-vous vraiment refuser cette demande d'inscription?</p>
                </div>
                <div class="p-3  mt-2 text-center space-x-4 md:block">
                    <button @click="del = !del" class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-md hover:shadow-lg hover:bg-gray-100">
                        Non
                    </button>
                    <Link
    ...
    <div v-if="addDoc"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter un nouveau doctorant</h3>
                        <form @submit.prevent="submit"
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="encadrant">
                                    Encadrant
                                </label>
    ...
    <div v-if="addCher"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter un nouveau un Chercheur</h3>
                        <form @submit.prevent="submit"
                              class="px-8 pt-6 pb-2 mb-4 bg-white rounded">
                            <div class="mb-4">
    ...
    <div v-if="add"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter Un Projet</h3>
                        <form @submit.prevent="submit"
                              class="px-8 pt-6 pb-2 mb-4 bg-white rounded">
                            <div class="mb-2">
    ...
    <div v-if="addAdmin"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter un nouveau admin</h3>
                        <form @submit.prevent="adminSubmit"
                            ...
                            <div class="mb-2">
                                ...
                                <div class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline">
                                    ...
                                    <label for="photo">cliquez ici pour télécharger la photo de profil</label>
                                </div>
                                <input
                                    @input="admin.photo = $event.target.files[0]"
                                    class="cursor-pointer absolute block opacity-0 pin-r pin-t"
                                    id="photo"
                                    name="photo"
                                    type="file"
    ...
    <div v-if="addChercheur"
         class="min-w-screen h-screen min-h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover">
        <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
        <div class="absolute bg-black opacity-80 inset-0 z-0"></div>
        <div class="mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="flex justify-center z-10 shadow-md">
                    <div class="bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter un nouveau chercheur</h3>
                        <form @submit.prevent="chercheurSubmit"
                              class="px-8 pt-6 pb-2 mb-4 bg-white rounded">
                            <div class="mb-6 grid grid-cols-2 md:grid-cols-3 gap-2.5">
                                <div class="mb-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700" for="nom">
                                        Nom
                                    </label>
                                    <input
                                        v-model="chercheur.nom"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="nom"
                                        name="nom"
                                        type="text"
                                ...
                                <div class="mb-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700" for="numero_telephone">
                                        Numero Telephone
                                    </label>
                                    <input
                                        v-model="chercheur.numero_telephone"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="numero_telephone"
                                ...
                                <div class="mb-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700" for="date_naissance">
                                        Date Naissance
                                    </label>
                                    <input
                                        v-model="chercheur.date_naissance"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="date_naissance"
                                        name="date_naissance"
                                        type="date"
                                ...
                                <div class="mb-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700" for="lieux_naissance">
                                        Lieux Naissance
                                    </label>
                                    <input
                                        v-model="chercheur.lieux_naissance"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="lieux_naissance"
                                        name="lieux_naissance"
                                        type="text"
                                        placeholder="Lieux Naissance"
                                        required
                                    />
                                </div>

                                <div class="mb-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700" for="cin">
                                        CIN
                                    </label>
                                    <input
                                        v-model="chercheur.cin"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="cin"
                                        name="cin"
                                        type="text"
                                ...
                                <div class="mb-2">
                                    ...
                                    <input
                                        @input="chercheur.photo = $event.target.files[0]"
                                        class="cursor-pointer absolute block opacity-0 pin-r pin-t"
                                        id="photo"
                                        name="photo"
                                        type="file"
                            ...
                            <hr class="mb-6 border-t" />
                            <div class="md:w-1/2 mx-auto grid grid-rows-2">
                                <div class="mb-6 text-center">
                                    <button
                                        class="w-full px-4 py-2 font-bold text-white bg-lab-purple rounded-full hover:bg-indigo-700 focus:outline-none focus:shadow-outline"
                                        type="submit">
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-8">
                <div class="flex justify-center z-10 shadow-md">
                    <div class="bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter un nouveau doctorant</h3>
                        <form @submit.prevent="doctorantSubmit"
                              class="px-8 pt-6 pb-2 bg-white rounded">
                            <div class="mb-6 grid grid-cols-2 md:grid-cols-3 gap-2.5">
                                <div class="mb-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700" for="nom">
                                        Nom
                                ...
                                <div class="mb-2">
                                    ...
                                    <input
                                        v-model="doctorant.numero_telephone"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="numero_telephone"
                                        name="numero_telephone"
                                        type="text"
                                ...
                                <div class="mb-2">
                                    ...
                                    <input
                                        v-model="doctorant.date_naissance"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="date_naissance"
                                        name="date_naissance"
                                        type="date"
                                ...
                                <div class="mb-2">
                                    ...
                                    <input
                                        v-model="doctorant.lieux_naissance"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="lieux_naissance"
                                        name="lieux_naissance"
                                        type="text"
                                ...
                                <div class="mb-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700" for="cne">
                                        CNE
                                    </label>
                                    <input
                                        v-model="doctorant.cne"
                                        class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                        id="cne"
                                        name="cne"
                                        type="text"
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline">
                                        ...
                                        <label for="photo">cliquez ici pour télécharger la photo</label>
                                    </div>
                                    <input
                                        @input="doctorant.photo = $event.target.files[0]"
                                        class="cursor-pointer absolute block opacity-0 pin-r pin-t"
                                        id="photo"
                                        name="photo"
                                        type="file"
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="w-full px-3 py-2 mb-3 text-sm bg-white leading-tight text-gray-700 text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                            name="chercheur"
                                            v-model="doctorant.chercheur_id">
                                        <option v-for="chercheur in chercheurs" :value="chercheur.id" :key="chercheur.id">{{chercheur.nom}}</option>
                                    </select>
                                </div>
                                <div class="mb-2">
                            ...
                            <div class="md:w-1/2 mx-auto grid grid-rows-2 md:grid-cols-2 md:gap-6 md:grid-rows-1">
                                <div class="mb-6 text-center">
                                    <button
                                        class="w-full px-4 py-2 font-bold text-white bg-lab-purple rounded-full hover:bg-indigo-700 focus:outline-none focus:shadow-outline"
                                        type="submit">
