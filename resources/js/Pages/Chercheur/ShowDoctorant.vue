            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container mx-auto px-6 py-8">
                        <h3 class="text-gray-700 text-3xl font-medium">Doctorants Encadrés</h3>

                        <div v-if="doctorants.length" class="mt-4">
                            <div class="w-full">
                                <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">


                                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        <div v-for="doctorant in doctorants"
                                            ...
                                            <div>
                                                <img class="object-center object-cover h-auto w-full"
                                                     :src="doctorant.photo" alt="photo">
                                            </div>
                                            <div class="text-center py-8 sm:py-6">
                                                <span class="text-xl font-bold mb-2">{{doctorant.nom}} {{doctorant.prenom}}</span>
                                                <p class="text-base text-lab-grey font-normal">{{doctorant.email}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                        ...
                        <div v-else class="container mx-auto px-6 pb-8">
                            <nocontent/>
                        </div>
                    </div>
