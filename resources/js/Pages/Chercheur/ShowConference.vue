...
watch(search, () => {
    tab.value = props.conferences.filter(
        conference => {
            for (const conferenceKey in conference) {
                if (conferenceKey['intitule'].toUpperCase().includes(search.value.toUpperCase()))
                    return conference
            }
        }
    )
...
function update() {
    Inertia.post('/conferences/chercheur/edit', conference)
...
const submit = () => {
    ...
    Inertia.post('/conferences/chercheur/store', form)
}
</script>
    ...
    <div v-if="addConf"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter une nouvelle conférence</h3>
            ...
            <div class="">
                ...
                <div class="p-3  mt-2 text-center space-x-4 md:block">
                    ...
                    <Link
                        ...
                        :href="`/conferences/chercheur/${delId}`"
                        method="delete"
                        as="button"
                        type="button">
                        Oui
    ...
    <div v-if="updateConf"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Editer une conférence</h3>
                        <form
                              class="px-8 pt-6 pb-2 mb-4 bg-white rounded">
                            <div class="mb-2">
                                <label class="block mb-2 text-sm font-bold text-gray-700" for="intitule">
