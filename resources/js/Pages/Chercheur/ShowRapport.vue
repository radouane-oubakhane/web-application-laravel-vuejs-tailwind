...
function etat(rapport) {
    form.id = rapport
    Inertia.post('/rapport/etat', form)
}
...
const search = ref('');
const tab = ref(props.doctorants);
const message = ref(true);
const errors = ref(true);

watch(search, () => {
    tab.value = props.doctorants.filter(
        doctorant => doctorant['nom'].toUpperCase().includes(search.value.toUpperCase())
    )
})
...
function download(rapport) {
    downl.id = rapport
    Inertia.get('/doctorants/rapport/download', downl)
}
</script>
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container mx-auto px-6 py-8">
                        ...
                        <div v-if="doctorants.length" class="flex flex-col mt-8">
                            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                <div>
                                    <div v-if="!annuler">
                                        <div v-for="i in doctorants.length"
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        <img class="object-center object-cover h-auto w-full"
                                                             :src="doctorants[i - 1].photo"
                                                             alt="photo">
                                                    </div>
                                                    <div class="text-center py-8 sm:py-6">
                                                        <span class="text-xl font-bold mb-2">{{doctorants[i - 1].nom}} {{doctorants[i - 1].prenom}}</span>
                                                        <p class="text-base text-lab-grey font-normal">{{doctorants[i - 1].email}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex flex-1 flex-col w-full">
                                                ...
                                                <div v-if="rapports[i - 1].length == 0"
