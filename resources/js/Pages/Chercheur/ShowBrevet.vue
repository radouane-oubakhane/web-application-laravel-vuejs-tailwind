...
let addBrevet = ref(false);
const delBre = ref(false);
const delId = ref(null);
const updateBre = ref(false);
...
const search = ref('');
const tab = ref(props.brevets);
const message = ref(true);
const errors = ref(true);

watch(search, () => {
    tab.value = props.brevets.filter(
        brevet => brevet['intitule'].toUpperCase().includes(search.value.toUpperCase())
    )
})
...
const submit = () => {
    addBrevet.value =! addBrevet.value
    Inertia.post('/brevets/store', form)
}
function updateBrevet(id) {
    updateBre.value = !updateBre.value
    brevet.id = id
}
function update() {
    Inertia.post('/brevets/edit', brevet)

}
function delBrevet(rapport) {
    delId.value = rapport
    delBre.value = !delBre.value
}
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container mx-auto px-6 py-8">
                        ...
                        <div class="px-6 py-8">
                            <button @click="addBrevet =! addBrevet" type="button" class="text-white bg-gradient-to-br from-green-600 to-green-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Ajouter un Brevet </button>
                        </div>
                        <div class="mt-8">
                        </div>
                        ...
                        <div v-if="brevets.length !== 0" class="flex flex-col mt-8">
                            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                <div
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tr v-for="brevet in brevets" v-if="!annuler">
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{brevet.intitule}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{brevet.type}}</div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{brevet.detail}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <p v-if="brevet.etat"
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <button
                                                    ...
                                                    @click="updateBrevet(brevet.id)">
                                                    Editer
                                                </button>
                                            </td>
                                            <td class="px-6 prapportsy-4 whitespace-no-wrap border-b border-gray-200">
                                                <button
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800"
                                                    @click="delBrevet(brevet.id)">
                                                    Supprimer
                                                </button>
                                            </td>

                                        </tr>
                                        <tr v-for="brevet in tab" v-if="annuler">
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">{{brevet.intitule}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
    ...
    <div v-if="addBrevet"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter un nouveau brevet</h3>
    ...
    <div v-if="delBre"
        ...
        <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
            <div class="">
                <div class="text-center p-5 flex-auto justify-center">
                    <h2 class="text-xl font-bold py-4 ">Êtes-vous sûr?</h2>
                    <p class="text-sm text-gray-500 px-8">Voulez-vous vraiment supprimer cet brevet?</p>
                </div>
                <div class="p-3  mt-2 text-center space-x-4 md:block">
                    <button @click="delBre = !delBre" class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-md hover:shadow-lg hover:bg-gray-100">
                        Non
                    </button>
                    <Link
    ...
    <div v-if="updateBre"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Editer un brevet</h3>
                        <form
                              class="px-8 pt-6 pb-2 mb-4 bg-white rounded">
                            <div class="mb-4 md:flex md:justify-between">
                                <div class="mb-4 md:mr-2 md:mb-0">
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    @input="brevet.fichier = $event.target.files[0]"
                                    class="cursor-pointer absolute block opacity-0 pin-r pin-t"
                                    id="fichier"
                                    name="fichier"
                                    type="file"
