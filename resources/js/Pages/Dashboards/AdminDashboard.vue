                        ...
                        <div class="mt-4">
                            <div class="flex flex-wrap -mx-6">
                                <div v-for="widget in widgets" :key="widget.title"
                                    class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-8">
                                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                        ...
                                        <div class="mx-5">
                                            <h4 class="text-2xl font-semibold" :class="widget.color">{{widget.num}}</h4>
                                            <div class="text-gray-500">{{widget.title}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div v-if="addCher"
        ...
        <div class="container mx-auto">
            <div class="flex justify-center px-6 my-12">
                <div class="w-full xl:w-3/4 lg:w-11/12 flex justify-center z-10 shadow-md">
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg">
                        <h3 class="pt-4 text-2xl text-center text-lab-purple">Ajouter un Chercheur</h3>
                        <form @submit.prevent="submit"
                              class="px-8 pt-6 pb-2 mb-4 bg-white rounded">
                            <div class="mb-4">
